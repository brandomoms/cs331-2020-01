...
\ Code from 3/25 - Forth: Words


cr cr
." This file contains sample code from March 25, 2020," cr
...
\ gcd
\ Compute gcd(a, b) using Euclidean Algorithm. a and b must be
\ nonnegative.
\
...
\ Try:
\   15 6 gcd .       \ Should be 3
\   1440 2330 gcd .  \ Should be 10
